...
/// Vista de perfil del Manager.
/// 
/// Muestra información personal del manager (3.1):
/// - Nombre, apellidos, cargo
/// - Email, teléfono
/// - Rol: Manager
/// - Datos de la organización
/// - Opciones de seguridad (cambiar contraseña, cerrar sesión)
class ManagerProfileView extends ConsumerStatefulWidget {
  const ManagerProfileView({super.key});

  @override
  ConsumerState<ManagerProfileView> createState() =>
      _ManagerProfileViewState();
}
