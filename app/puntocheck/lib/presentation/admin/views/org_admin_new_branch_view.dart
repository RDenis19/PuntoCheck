...
class OrgAdminNewBranchView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OrgAdminNewBranchView> createState() => _OrgAdminNewBranchViewState();
}
...
class _OrgAdminNewBranchViewState extends ConsumerState<OrgAdminNewBranchView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: ref.watch(orgAdminOrganizationProvider).when(
          data: (org) {
            return Stack(
              children: [
                GoogleMap(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          const Spacer(),
                                          IconButton(
                                            onPressed: () => setState(() => _sheetVisible = false),
                      ...
                      : Align(
                          ...
                          child: Padding(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              onPressed: () => setState(() => _sheetVisible = true),
  ...
  Future<void> _save(String orgId) async {
    ...
    try {
      ...
      await ref.read(organizationServiceProvider).createBranch(sucursal);
      if (!mounted) return;
