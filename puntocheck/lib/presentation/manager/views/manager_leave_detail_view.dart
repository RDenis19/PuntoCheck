...
/// - Aprobar permisos pendientes de su equipo
/// - Rechazar permisos pendientes de su equipo
class ManagerLeaveDetailView extends ConsumerStatefulWidget {
  ...
  ConsumerState<ManagerLeaveDetailView> createState() =>
      _ManagerLeaveDetailViewState();
}

class _ManagerLeaveDetailViewState
    extends ConsumerState<ManagerLeaveDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.watch(managerPermissionControllerProvider);
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Ej: Aprobado por buen desempeño...',
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () {
            // Retornar el comentario (puede estar vacío)
        ...
        ElevatedButton(
          onPressed: () {
            ...
            if (text.isEmpty) {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('El comentario es obligatorio para rechazar'),
                  backgroundColor: AppColors.errorRed,
                ),
              );
              return;
